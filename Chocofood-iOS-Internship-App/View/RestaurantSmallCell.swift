...
//        imageView.layer.masksToBounds = false
    ...
    lazy var ratingView: UIView! = {
        let view = UIView()
        view.backgroundColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 46/100)
    ...
    lazy var restaurantDeliveryMinTime: UILabel! = {
        let time = UILabel()
        time.font = UIFont(name: "AvenirNext-Regular", size: 7)
    ...
    func setupViews() {
        ...
        sendSubviewToBack(restaurantImage)
    ...
    func setupConstraints() {
        ...
        restaurantTitle.centerXAnchor.constraint(equalTo: centerXAnchor).isActive = true
        restaurantTitle.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
        
        
        restaurantImage.widthAnchor.constraint(equalTo: widthAnchor).isActive = true
        restaurantImage.heightAnchor.constraint(equalTo: heightAnchor).isActive = true
        restaurantImage.centerXAnchor.constraint(equalTo: centerXAnchor).isActive = true
        restaurantImage.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
        
        infoView.rightAnchor.constraint(equalTo: rightAnchor, constant: -5.5).isActive = true
        infoView.leftAnchor.constraint(equalTo: leftAnchor, constant: 5.5).isActive = true
        ...
        deliveryPriceView.rightAnchor.constraint(equalTo: rightAnchor, constant: -4).isActive = true
        deliveryPriceView.topAnchor.constraint(equalTo: topAnchor, constant: 2).isActive = true
        deliveryPriceView.heightAnchor.constraint(equalToConstant: 25).isActive = true
//        deliveryPriceView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -90).isActive = true
